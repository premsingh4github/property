...
define( 'SEED_CSPV4_VERSION', '4.5.3' ); // Plugin Version Number. Recommend you use Semantic Versioning http://semver.org/
...
require_once( dirname( __FILE__ ) .'/sellwp-updater.php' );
 ...
 */
 ...
 //Global
 require_once( dirname( __FILE__ ) .'/includes/seedredux-overrides.php' );
 require_once( dirname( __FILE__ ) .'/includes/class-cspv4.php' );
 require_once( dirname( __FILE__ ) .'/includes/seed-cspv4-plugin-template-loader.php' );
 require_once( dirname( __FILE__ ) .'/includes/template-tags.php' );
 require_once( dirname( __FILE__ ) .'/includes/functions.php' );
 require_once( dirname( __FILE__ ) .'/includes/import-v3.php' );
