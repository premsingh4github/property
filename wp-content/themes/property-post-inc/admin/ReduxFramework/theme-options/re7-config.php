<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array (
                'desc' => 'Drag and drop layout manager, to quickly organize your homepage contents. If you\re using the dsIDXPress plugin you can use the dsIDXpress block to replace the homepage search. Keep in mind that it will only search IDX listings not manually entered listings. If you\'re using the Single Listing layout only the following blocks are available Call to Action, Testimonials, Partners, Page Builder & Page Builder Two.',
                'id' => 'ct_home_layout',
                'type' => 'sorter',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array (
                'desc' => 'Pick a background color for the lsitings property info area.',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
           array (
            ...
            array (
                'desc' => 'Select whether you\'d like to use Zipcode or Postcode.',
                'id' => 'ct_zip_or_post',
                'type' => 'select',
                'options' => array (
                    'zipcode' => 'Zipcode',
        ...
        Redux::setSection( $opt_name, array(
            ...
            'fields'           => array(
                ...
                array (
                        ...
                        'type' => 'info',
                        'raw' => 'Create a Page > Insert the {{wp-favorite-posts}} shortcode in the body content > Copy the ID of that Page and paste it below, once thats complete a link will appear in the top bar of the site.',
                    ),
                array (
