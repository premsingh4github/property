...
function ct_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name' 		=> 'Contempo Real Estate Custom Posts',
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/admin/plugins/js_composer.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			'name'     				=> 'Frontend Edit Profile', // The plugin name
			'slug'     				=> 'frontend-edit-profile', // The plugin slug (typically the folder name)
			'source'   				=> get_stylesheet_directory() . '/admin/plugins/frontend-edit-profile.zip', // The plugin source
