		...
		echo '<div class="widget-inner">';
			if($logo == "Yes") { ?>
				<?php if(!empty($ct_options['ct_logo']['url'])) { ?>
					<a href="<?php echo home_url(); ?>"><img class="widget-logo marB30" src="<?php echo esc_url($ct_options['ct_logo']['url']); ?>" alt="<?php bloginfo('name'); ?>" /></a>
				<?php } else { ?>
					<a href="<?php echo home_url(); ?>"><img class="widget-logo marB30" src="<?php echo get_template_directory_uri(); ?>/images/re7-logo.png" alt="WP Pro Real Estate 7" /></a>
				<?php } ?>
			<?php } ?>
	        <?php if($blurb) { ?><p class="marB15"><?php echo esc_html($blurb); ?></p><?php } ?>

	        <ul class="contact-info">
	            <?php if($street) { ?><li><i class="fa fa-home"></i> <?php echo esc_html($street); ?><br /><?php echo esc_html($city); ?>, <?php echo esc_html($state); ?> <?php echo esc_html($postal); ?><br /><?php echo esc_html($country); ?></li><?php } ?>
	            <?php if($phone) { ?><li><i class="fa fa-phone"></i> <?php echo esc_html($phone); ?></li><?php } ?>
