...
jQuery(document).ready(function($) {
	...
	jQuery(function($) {
		...
		var uploader = new plupload.Uploader({
			...
			url: AdminURL.ajaxUrl + "?action=ct_front_img_upload&_wpnonce="+jQuery('#post_nonce_field').val(),
			max_retries: 3,
			filters: {
				mime_types : [
