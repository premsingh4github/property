    			...
    			<form action="" id="primaryPostForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col span_6 first">
                        ...
                        <div class="col span_4">
                            ...
                            <label><?php esc_html_e('Classification', 'contempo'); ?></label>
                              <?php ct_submit_listing_form_select('classification'); ?>
                             </div>
                        ...
                        <div class="col span_4">
                            ...
                            <input type="text" name="customMetaCommissionPercentage" id="customMetaCommissionPercentage" value="<?php if(isset($_POST['customMetaCommissionPercentage'])) echo esc_attr($_POST['customMetaCommissionPercentage']);?>" />
                        </div>
                       <?php } ?>          
                        <div class="col span_4">
                            <label><?php esc_html_e('Contact Number', 'contempo'); ?></label>
                            <input type="text" name="customMetaContactNumber" id="customMetaContactNumber" value="<?php if(isset($_POST['customMetaContactNumber'])) echo esc_attr($_POST['customMetaContactNumber']);?>" />
                        </div>
                    ...
                    <div class="col span_6">
                        ...
                        <div class="col span_4">
                            ...
                            <input type="text" name="customTaxParking" id="customTaxParking" 
                                   value="<?php if(isset($_POST['customTaxParking'])) echo esc_attr($_POST['customTaxParking']);?>" />
                        </div>
                        ...
                        <div class="col span_4 first">
                         ...
                         <div class="col span_4">
                            ...
                            <input type="text" name="customMetafloorarea" id="customMetafloorarea" value="<?php if(isset($_POST['customMetafloorarea'])) echo esc_attr($_POST['customMetafloorarea']);?>" />
                        </div>
