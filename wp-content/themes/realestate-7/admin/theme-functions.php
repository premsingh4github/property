...
if(!function_exists('ct_memory_bump')) {
...
if(!function_exists('ct_init_scripts')) {
	function ct_init_scripts() {
		...
		if(is_page_template('template-edit-profile.php')) {
			...
			wp_enqueue_script('ctPassStrength', get_template_directory_uri() . '/js/ct.passwordstrength.js', 'jquery', '1.0', false);
		}
		...
		if(!is_page_template('template-submit-listing.php')){
			wp_enqueue_script('gmaps', '//maps.google.com/maps/api/js', '', '1.0', false);
		}
		
		if(is_page_template('template-submit-listing.php')){
			wp_enqueue_script('gmapsPlaces', '//maps.googleapis.com/maps/api/js?v=3.exp&signed_in=true&libraries=places', '', '1.0', false);
...
if(!function_exists('ct_wp_head')) {
	function ct_wp_head() {
		...
		echo '<style type="text/css">';
			...
			echo 'body, .slider-wrap { font-family: "' . esc_html($ct_options['ct_body_font']) . '";}';
			echo '.fa-close:before { content: "\f00d";}';
			if($ct_use_propinfo_icons == 'icons') { echo '.propinfo li { line-height: 2.35em;} .row.baths svg { position: relative; top: 3px; left: -2px;}'; }
...
if(!function_exists('ct_sqftsqm')) {
	function ct_sqftsqm() {
		...
		if($ct_options['ct_sq'] == "sqft") {
			...
			return _e(' m<sup>2</sup>', 'contempo');
...
if(!function_exists('ct_acres')) {
	function ct_acres() {
		...
		if($ct_options['ct_acres'] == "acres") {
			...
			return esc_html_e(' m', 'contempo') . '<sup>2</sup>';
...
if(!function_exists('ct_first_image_linked_portfolio_widget')) {
...
if(!function_exists('ct_first_image_linked_widget')) {
	function ct_first_image_linked_widget() { ?><a class="thumb" href="<?php the_permalink(); ?>"><?php the_post_thumbnail(array(800,600)); ?></a><?php } 
}
