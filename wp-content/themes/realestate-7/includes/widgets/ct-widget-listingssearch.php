            ...
            <form id="advanced_search" name="search-listings" action="<?php echo home_url(); ?>">
               ...
               <?php
                ...
                foreach ($ct_home_adv_search_fields as $field=>$value) {
                    ...
                    case 'sqft_from' : ?>
                        <div class="left">
                            <label for="sqft_from"><?php ct_sqftsqm(); ?> <?php _e('From', 'contempo'); ?></label>
                            <input type="text" id="sqft_from" class="number" name="sqft_from" size="8" placeholder="<?php ct_sqftsqm(); ?> <?php _e('From', 'contempo'); ?>" />
                        </div>
                    <?php
                    break;
                    ...
                    case 'sqft_to' : ?>
                        <div class="left">
                            <label for="sqft_to"><?php ct_sqftsqm(); ?> <?php _e('To', 'contempo'); ?></label>
                            <input type="text" id="sqft_to" class="number" name="sqft_to" size="8" placeholder="<?php ct_sqftsqm(); ?> <?php _e('To', 'contempo'); ?>" />
                        </div>
                    <?php
                    break;
