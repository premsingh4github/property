				...
				<form id="advanced_search" name="search-listings" action="<?php echo home_url(); ?>">
				    ...
				    <div class="form-loader"><i class="fa fa-circle-o-notch fa-spin"></i></div>
			            ...
			            <div class="col span_4 first">
			                ...
			                <input type="text" id="ct_sqft_from" class="number" name="ct_sqft_from" size="8" placeholder="<?php ct_sqftsqm(); ?> <?php _e('From', 'contempo'); ?>" />
			            </div>
			       
			            <div class="col span_4">
			                <label for="ct_sqft_to"><?php ct_sqftsqm(); ?> <?php _e('To', 'contempo'); ?></label>
			                <input type="text" id="ct_sqft_to" class="number" name="ct_sqft_to" size="8" placeholder="<?php ct_sqftsqm(); ?> <?php _e('To', 'contempo'); ?>" />
			            </div>
